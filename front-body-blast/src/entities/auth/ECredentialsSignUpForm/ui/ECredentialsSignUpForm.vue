...
import { useHandlerWrapper, SForm } from 'shared/ui/SForm';
import { SInput } from 'shared/ui/SInput';

const authStore = useAuthStore();
const signUpState = ref(authStore.signUpState);
const onsubmit = useHandlerWrapper(authStore.signUp);
...
<template>
  <SForm :loading="signUpState.state.isLoading()" @submit="onsubmit" :field-schema="validationSchema">
