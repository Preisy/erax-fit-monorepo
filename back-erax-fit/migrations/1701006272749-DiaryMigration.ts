...
export class DiaryMigration1701006272749 implements MigrationInterface {
  name = 'DiaryMigration1701006272749';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "self-control-props" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "label" character varying NOT NULL, "value" integer, "templateId" integer NOT NULL, CONSTRAINT "PK_813c99a0faf2a6f33a336ec3887" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "self-control" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "behavior" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "sum" integer NOT NULL, "activity" character varying NOT NULL, "steps" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_d96193744b513150000eb48e39f" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "self-control-props" ADD CONSTRAINT "FK_41401b301c1635ea93d66dca9a7" FOREIGN KEY ("templateId") REFERENCES "diary-templates"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_8c95edc5c53f3407a7c816070ff" FOREIGN KEY ("templateId") REFERENCES "diary-templates"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query('INSERT INTO "self-control-props" ("label", "templateId") VALUES (\'Сон\', 1)');
    await queryRunner.query(
      'INSERT INTO "self-control-props" ("label", "templateId") VALUES (\'Работоспособность\', 1)',
    );
    await queryRunner.query('INSERT INTO "self-control-props" ("label", "templateId") VALUES (\'Питание\', 1)');
    await queryRunner.query(
      'INSERT INTO "self-control-props" ("label", "templateId") VALUES (\'Слежу за здоровьем\', 1)',
    );
  }
