...
export class NutritionMigration1699463729631 implements MigrationInterface {
    name = 'NutritionMigration1699463729631'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "meal-items" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "category" integer NOT NULL, "type" character varying NOT NULL, "quantity" character varying NOT NULL, "mealId" integer NOT NULL, CONSTRAINT "PK_9ca583c20b7ec790a47a679e0ea" PRIMARY KEY ("id"))`);
